...
import TimeKeeping.View.ThongTinDiemDanh;
import TimeKeeping.View.ThongTinNhanVien;
 ...
 * @author Ad
 */
public class ChuyenManHinhQuanLy {
    private JPanel root;
    private String kindSelected = "";
    private List<DanhMucBean> listItem = null;

    public ChuyenManHinhQuanLy(JPanel jpnRoot) {
        this.root = jpnRoot;
    }
